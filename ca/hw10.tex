		...
		\thispagestyle{empty}\setlength{\parindent}{0pt}
 		...
 		\begin{enumerate}
 			\item \begin{enumerate}
 				...
 				\item  $f(z)=e^{2z}-1\\e^z-1=0,\tab e^z=1,\tab z=\Ln(1)=\ln1+i(\arg1+2\pi k)=2\pi ik,k\in\mathbb{Z}\\(f(z))'\big|_{z_k}=e^{z_k}=e^{2\pi ik}=\cos2\pi k+i\sin2\pi k=1+0=1\\$ точки $z_k$ нулі I порядку.
