...
\begin{figure*}[htp]\centering
	\begin{tikzpicture}[scale=0.8]
		\begin{axis}[color=grey!20,ticks=none,axis lines=middle, xmin=-0.2,xmax=0.8,ymin=-0.5,ymax=0.5]	
		\end{axis}
		\draw[color=grey!20] (3,0.2) -- (3,5.5) node[right,color=grey!20] {$z=1+iy$};
		\draw[color=grey!20] (3,2.5) node[right] {1};
	\end{tikzpicture}
	\begin{tikzpicture}[scale=0.8]
		\begin{axis}[color=grey!20,ticks=none,axis lines=middle, xmin=-0.2,xmax=0.8,ymin=-0.5,ymax=0.5]	
		\end{axis}
		\draw[rotate=180,color=grey!20] (-1.4,-4.8) arc(270:90:0.7 and 2);
		\draw[color=grey!20] (1.2,0.8) node[left,color=grey!20] {-2} -- (1.4,0.8);
		\draw[color=grey!20] (1.2,4.8) node[left,color=grey!20] {-2} -- (1.4,4.8);
		\draw[color=grey!20] (2,2.5) node[right] {1};
	\end{tikzpicture}
\end{figure*}\newpage
\section{A}
